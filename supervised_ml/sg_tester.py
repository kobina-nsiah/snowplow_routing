...
def compute_summary_metrics(model: SequenceRoutingModel, data_loader, main_graph, device="cpu"):
    """
...
def evaluate_model(model: SequenceRoutingModel, data_loader, main_graph, device="cpu"):
    """
